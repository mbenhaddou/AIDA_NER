package aida.preparator.inputformat.xml;
...
//    factory.setProperty("http://java.sun.com/xml/stream/properties/ignore-external-dtd", Boolean.TRUE);
  ...
  @Override
  public PreparedCandidates prepare(String docid, String content, PreparationSettings prepSettings) throws Exception {
...
//      mapper.process(text);
//    }
    PreparedCandidates pInp = Preparator.prepareInputData(
            xmlExtraction.getContent(), uniqueId, prepSettings);
