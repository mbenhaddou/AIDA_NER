...
public class PreparedCandidates implements Iterable<PreparedInputChunk> {
  
  private Logger logger_ = LoggerFactory.getLogger(PreparedCandidates.class);
  ...
  public PreparedCandidates(String docId, String text, List<PreparedInputChunk> chunks) {
    setDocId(docId);
    text_ = text;
    chunks_ = chunks;
  }
   ...
   */
  public PreparedCandidates(File file) {
    this(file, 0, true);
  }
   ...
   */
  public PreparedCandidates(File file, int mentionMinOccurrences, boolean inludeOODMentions) {
