...
public class Language implements Comparable<Language>{
  ...
  protected static final Map<String,String> getPronounTypes(String id) {
    ...
    }catch(LanguageNotSupportedException ex){System.out.println(ex);}    
    return lang;
	}
  ...
  public static void main(String[] argv) throws Exception {
    for (String langID : supported.keySet()){
      ...
      System.out.println("Language ID:'"+langID+"' full name:'"+lang.getLongForm()+"'");
      assert(lang.getLongForm().equals(supported.get(langID)));
      System.out.println("Pronouns: "+lang.getPronouns());
